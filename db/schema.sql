...
DO $$ BEGIN CREATE TYPE workspace_status AS ENUM ('NOT_STARTED','COLLECTING_DOCUMENTS','MISSING_ITEMS','READY_FOR_PREPARATION','IN_PREPARATION','ADDITIONAL_INFO_REQUESTED','READY_TO_FILE','FILED','ARCHIVED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE checklist_status AS ENUM ('EXPECTED','REQUESTED','RECEIVED','WAIVED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE TYPE document_review_status AS ENUM ('REVIEW_REQUIRED','ACCEPTED','REJECTED'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
